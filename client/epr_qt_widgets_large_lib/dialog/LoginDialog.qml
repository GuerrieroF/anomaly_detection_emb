...
Item {
    ...
    property alias wrongPassword: input.isWrongPassword
    readonly property alias passwordString: input.passwordString
    ...
    ModalHeader {
        ...
        ModalTopTitleContent {
            ...
            showMetadata: false
            header: "Login"
            message: "User persona"

        }

        ModalLoginInputContent {
            id: input
            ...
            anchors.leftMargin: header.leftPad
            anchors.rightMargin: header.rightPad
            isWrongPassword: container.wrongPassword
